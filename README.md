...
#### 1. Create an .txt file containing your machine code instruction. For the instruciton formate, Please refer to the file text.txt. That set of instructions will first LOAD the bit pattern found in memory 1A to register 2, and ten STORE the bit pattern in register 23 to register. Lastly will tell the machine to stop.
